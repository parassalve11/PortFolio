    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div className="col-span-1 lg:col-span-2 h-full bg-gray-100 min-h-[500px] lg:min-h-[300px] rounded-2xl p-8">
        <h1 className="text-4xl lg:text-6xl font-medium ">
          Hey I am Paras Salve 🚀
        </h1>
        <h1 className="text-3xl lg:text-5xl font-normal mt-3 ">
          A passionate Softwere Devloper with Experience in  
           <Link href={'projects'} className="text-sky-600 font-semibold px-3 hover:underline underline-sky-500">
            Project Devlopment
          </Link>
        </h1>

        <a
          href="mailto:parassalve50@gmail.com"
